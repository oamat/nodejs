...
const { hget, lpush, sadd } = require('../util/redis');
...
router.post('/smsSend', auth, async (req, res) => {
    ...
    try {
        ...
        sms.channel = "SMS." + sms.operator + "." + sms.priority; //get the channel to put notification 
        ...
        lpush(sms.channel, JSON.stringify(sms));   // the lists channels: SMS.MOV.1, SMS.VIP.1, SMS.ORA.1, SMS.VOD.1 (1,2,3) 
