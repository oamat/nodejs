...
echo "# You can enter inside container: 'kubectl exec -it [pod] -- /bin/bash'"
echo "# You can scale deployment: kubectl scale deployments/apisms --replicas=3 & kubectl describe services/apisms"